...
## [1.5] - 31-07-2025
### Fixed
- Corrected an error in sym_links.sh file that led data dependencies not to be downloaded nor linked properly.
- C++ header files (.hpp) are now properly treated during symbolic link creation process.
